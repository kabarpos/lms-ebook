            ...
            <div class="prose prose-lg max-w-none">
                ...
                <div class="bg-gray-50 rounded-xl p-8 mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                        <div class="w-8 h-8 bg-lochmara-100 rounded-lg flex items-center justify-center mr-3">
                ...
                <!-- Contact Information -->
                <div class="bg-lochmara-50 border border-lochmara-200 rounded-xl p-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                        <div class="w-8 h-8 bg-lochmara-600 rounded-lg flex items-center justify-center mr-3">
