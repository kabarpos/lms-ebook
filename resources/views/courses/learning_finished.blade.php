...
<div class="relative flex justify-center">
    ...
    <main class="relative mt-[178px] flex flex-col gap-[30px] p-[30px] w-[560px] rounded-[20px] border bg-white border-LMS-grey">
        ...
        <div class="buttons grid grid-cols-2 gap-[12px]">
            ...
            <a href="{{ route('dashboard') }}" class="text-white rounded-full py-[10px] flex justify-center items-center bg-LMS-green hover:drop-shadow-effect transition-all duration-300">
