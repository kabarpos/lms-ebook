...
@section('content')
    ...
    <nav id="bottom-nav" class="flex w-full bg-white border-b border-LMS-grey py-[14px]">
        <ul class="flex w-full max-w-[1280px] px-[75px] mx-auto gap-3">
            <li class="group">
                <a href="#"
                    class="flex items-center gap-2 rounded-full border border-LMS-grey py-2 px-[14px] hover:border-LMS-green bg-white transition-all duration-300 group-[.active]:bg-LMS-light-green group-[.active]:border-LMS-light-green cursor-pointer">
