...
@section('title', 'Checkout - LMS DripCourse')
@section('content')
    <x-navigation-auth />
    <div id="path" class="flex w-full bg-white border-b border-LMS-grey py-[14px]">
        <div class="flex items-center w-full max-w-[1280px] px-[75px] mx-auto gap-5">
            <a href="{{ route('front.index') }}" class="last-of-type:font-semibold cursor-pointer">Home</a>
            <div class="h-10 w-px bg-LMS-grey"></div>
            <a href="{{ route('front.pricing') }}" class="last-of-type:font-semibold cursor-pointer">Pricing Packages</a>
            <span class="text-LMS-grey">/</span>
            <a href="#" class="last-of-type:font-semibold cursor-pointer">Checkout Subscription</a>
        </div>
    </div>
        ...
        <div class="flex w-[1000px] !h-fit rounded-[20px] border border-LMS-grey gap-[40px] bg-white items-center p-5">
            <form id="checkout-details" class="w-full flex flex-col gap-5">
                    ...
                    <div class="flex items-center justify-between rounded-[20px] border border-LMS-grey p-[14px]">
                        <div class="profile flex items-center gap-[14px]">
                            ...
                            <div class="desc flex flex-col gap-[3px]">
                                ...
                                <p class="text-sm leading-[21px] text-LMS-text-secondary">{{ $user->occupation }}</p>
                            </div>
                        </div>
                        <a href="#" class="cursor-pointer">
                            <p class="text-sm leading-[21px] hover:underline text-LMS-green">Change Account</p>
                        </a>
                    </div>
                </section>
                <section id="transaction-details" class="flex flex-col gap-[12px]">
                    ...
                    <div class="flex flex-col gap-[12px]">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <strong class="font-bold text-[22px] leading-[33px] text-LMS-green">
                ...
                <div class="grid grid-cols-2 gap-[14px]">
                    <a href="pricing.html" class="cursor-pointer">
                        <div
                            class="flex border border-LMS-grey rounded-full items-center justify-center py-[10px] hover:border-LMS-green transition-all duration-300">
                            <p class="font-semibold">Cancel</p>
                        </div>
                    </a>
                    <button id="pay-button" type="submit"
                        class="flex text-white bg-LMS-green rounded-full items-center justify-center py-[10px] hover:drop-shadow-effect transition-all duration-300 cursor-pointer">
                        <p class="font-semibold">Pay Now</p>
                    </button>
                </div>
                <hr class="border-LMS-grey" />
                <p class="text-sm leading-[21px] text-center hover:underline text-LMS-text-secondary">Pahami Terms &
            ...
            <div id="benefits" class="bg-[#F8FAF9] rounded-[20px] overflow-hidden shrink-0 w-[420px]">
                ...
                <section id="points" class="pt-[61px] relative flex flex-col gap-4 px-5 pb-5">
                    <div
                        class="card absolute -top-[47px] left-[30px] right-[30px] flex items-center p-4 gap-[14px] border border-LMS-grey rounded-[20px] bg-white shadow-[0px_10px_30px_0px_#B8B8B840]">
                        ...
                        <div>
                            ...
                            <p class="text-LMS-text-secondary">{{ $pricing->duration }} months duration</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
